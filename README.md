The catdog web service
======================

The catdog web service offers an API that provides a service of image 
classification for cats and dogs. The API can be used by any web or mobile
applications that needs such a critical functionality. 

This project was initially bootstrapped using AWS CodeStar with the 
sample web service template. It was modified to serve as a demo for the 
GPSE Machine Learning Engineering Workshop (MLEW). 
...
Manual modifications needed after CloudFormation deployment
-----------------------------------------------------------
Generally follow these steps: https://aws.amazon.com/blogs/compute/binary-support-for-api-integrations-with-amazon-api-gateway/
and these https://aws.amazon.com/premiumsupport/knowledge-center/custom-headers-api-gateway-lambda/

The mapping used should be:
